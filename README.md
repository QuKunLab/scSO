...
If the above operations are successfully completed, you can execute the sample file of scSO: [demo_test.py](./scSO_py/Linux/demo_test.py)
...
If the above operations are successfully completed, you can execute the sample file of scSO: [demo_test.py](./scSO_py/Windows/demo_test.py)
